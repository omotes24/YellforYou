    ...
    <AppShell>
      ...
      <article className="grid gap-5 rounded-[28px] bg-white p-6 text-sm font-medium leading-7 text-[#424245] shadow-sm ring-1 ring-black/[0.06]">
        <section>
          ...
          <p className="mt-2">
            ログイン後、プロフィール、企業・求人情報、面接前学習メモ、明示保存した面接履歴、回答チャット履歴、ユーザー設定をSupabaseに保存します。問い合わせフォームでは、名前、返信先メールアドレス、問い合わせ種別、件名、本文を送信します。テーマ設定はブラウザのlocalStorageに保存される場合があります。
          </p>
        </section>
        <section>
